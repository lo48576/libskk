...
static void
file_dict_minimal (void)
{
  GError *error = NULL;
  SkkFileDict *dict = skk_file_dict_new (LIBSKK_FILE_DICT_MINIMAL, "EUC-JP", &error);
  g_assert_no_error (error);
...
main (int argc, char **argv)
{
  ...
  g_test_add_func ("/libskk/file-dict-minimal", file_dict_minimal);
  return g_test_run ();
}
